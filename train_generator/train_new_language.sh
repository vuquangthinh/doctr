...
python references/recognition/train_pytorch.py crnn_vgg16_bn --lr 0.001 --train_path ./data/${MODEL}/train_data --val_path ./data/${MODEL}/val_data --epochs 50  --input_size 32 --vocab khm --resume crnn_vgg16_bn_20240307-111230.pt
