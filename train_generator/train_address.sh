...
python references/recognition/train_pytorch.py crnn_vgg16_bn --pretrained --lr 0.001 --train_path ./data/${MODEL}/train_data --val_path ./data/${MODEL}/val_data --epochs 100 --input_size 32 --vocab khm --name ${MODEL} --resume ${MODEL}.pt