...
# need optimize list / retrain
VOCABS['khm'] = "".join(
    dict.fromkeys(
    """កខគឃងចឆជឈញដឋឌឍណតថទធនបផពភមយរលវឝឞសហឡអឣឤឥឦឧឨឩឪឫឬឭឮឯឰឱឲឳ឴឵ាិីឹឺុូួើឿៀេែៃោៅំះៈ៉៊់៌៍៎៏័៑្៓។៕៖ៗ៘៙៚៛ៜ៝០១២៣៤៥៦៧៨៩៰៱៲៳៴៵៶៷៸៹᧠᧡᧢᧣᧤᧥᧦᧧᧨᧩᧪᧫᧬᧭᧮᧯᧰᧱᧲᧳᧴᧵᧶᧷᧸᧹᧺᧻᧼᧽᧾᧿Ⳉⳉ"""
    + VOCABS['latin']
    +   ''.join(['˜', "'", '“', '.', ',', '"', '!', '”', '»', '?', '&', '«', '[', ']', '°', '~', '¦', '£', '$', '%', '€', '…', '^', '&', '×', '@', '‹', '›', '⁄', '#', '±', '‘', '_', '¥', '©', '÷', '’', '²', '„', '¬'])
))

VOCABS['khm2'] = VOCABS['khm'] + "ព្រះ‌"
VOCABS['mrz_code'] = string.ascii_uppercase + string.digits + '<'
VOCABS['khm_date'] = '០១២៣៤៥៦៧៨៩.'
