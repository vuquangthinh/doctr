...
VOCABS['khm'] = 'កខគឃងចឆជឈញដឋឌឍណតថទធនបផពភមយរលវឝឞសហឡអឣឤឥឦឧឨឩឪឫឬឭឮឯឰឱឲឳ឴឵ាិីឹឺុូួើឿៀេែៃោៅំះៈ៉៊់៌៍៎៏័៑្៓។៕៖ៗ៘៙៚៛ៜ៝០១២៣៤៥៦៧៨៩៰៱៲៳៴៵៶៷៸៹᧠᧡᧢᧣᧤᧥᧦᧧᧨᧩᧪᧫᧬᧭᧮᧯᧰᧱᧲᧳᧴᧵᧶᧷᧸᧹᧺᧻᧼᧽᧾᧿Ⳉⳉ' + ''.join(['˜', "'", '“', '.', ',', '"', '4', '7', '3', '6', '!', 
               '2', '”', '»', '8', 'g', '0', 'p', '?', '&', '5', '1', '9', '«', 
               'j', '[', ']', '°', '~', '¦', '£', '$', '%', '€', '…', '^', '&', 
               '×', '@', '‹', '›', '⁄', '#', '±', '‘', '_', '¥', '©', '÷', '’', ' '])
# + VOCABS['latin'] # + VOCABS['punctuation']
